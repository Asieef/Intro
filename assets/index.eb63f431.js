...
const Zl = Ft(Wl, [["render", Xl]]),
  ...
  rc = {},
  oc = Mr(
    '<div class="container mx-auto lg:mt-24 mt-12 lg:px-6"><div class="grid lg:grid-cols-2 justify-items-center lg:gap-40 gap-20"><div class="block lg:hidden"><img src="' +
      Ql +
      '" class="w-80"></div><div class="col-span-1"><div class="grid grid-flow-row lg:gap-8 gap-4 px-4"><h2 class="text-6xl font-bold lg:block hidden"> Make <br> Remote Work </h2><h2 class="text-3xl font-bold lg:hidden block">Make Remote Work</h2><p class="text-xs text-gray-600 font-semibold"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita aliquam molestias laborum tempore nobis? Adipisci, voluptatem? Voluptates ipsa aliquam quibusdam. </p><div class="flex justify-center lg:justify-start"><button class="bg-black text-white border font-semibold p-2 rounded-md hover:bg-white hover:text-black w-32"> Learn More </button></div><div class="flex gap-6 lg:mt-12 mt-8"><img class="h-3 lg:h-5" src="' +
      Gl +
